...
class FeatureLossOurs(nn.Module):
    ...
    def __init__(self,
        ...
        super(FeatureLossOurs, self).__init__()
    ...
    def bmse_loss(self, input, target, noise_sigma=8.):
        return self.bmc_loss(input, target, noise_sigma ** 2)
    ...
    def get_dis_loss(self, preds_S, preds_T):
        ...
        # dis_loss = self.bmse_loss(preds_T, new_fea)/N

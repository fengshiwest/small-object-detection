...
def coco2voc(anno, anno2, xml_dir):
    ...
    for i in tqdm(range(len(imgs))):
        ...
        file_path = os.path.join(xml_dir, file_name.split('/')[0])
        ...
        if not os.path.exists(xml_path):
            ...
            xml_content.append("        <database>UAVDT</database>")
            xml_content.append("    </source>")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', type=str, help='path to json file.', default="data/UAVDT/annotations/instance_UFP_gfocal_r50_fpn_1x_ciou_pretrained_ignore_lr0008_UAVval.json")
    parser.add_argument('--anno_path', type=str, help='path to json file.', default="data/UAVDT/annotations/instance_UFP_gfocal_r50_fpn_1x_ciou_pretrained_ignore_lr0008_UAVval.json")
    parser.add_argument('--output', type=str, help='path to output xml files.', default="data/UAVDT/UAVDT_instance_UFP_gfocal_r50_fpn_1x_ciou_pretrained_ignore_lr0008_UAVval_xml")

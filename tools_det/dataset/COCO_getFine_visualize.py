...
def main():
    ...
    for key in coco.imgs.keys():
        ...
        # show_result_pyplot(detector, img, first_results, score_thr=0.3)
        ...
        # ufp_img_show = ufp_img[:, :, ::-1]
        # import matplotlib.pyplot as plt
        # plt.imshow(ufp_img_show/255)
        # plt.show()
            ...
            for idx, anno in enumerate(cur_annotation):
                ...
                if (compute_iof(t_bbox, g_bbox) > 0.9):
                    ...
                    if 'bbox' in new_anno:
                        ...
                        cv2.rectangle(ufp_img, (xmin, ymin), (xmax, ymax), (255, 102, 61), 2)
                        cv2.imwrite(os.path.join(ufp_images_output_dir, img_name), ufp_img)
                        # print(1)

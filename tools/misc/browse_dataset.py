...
def retrieve_data_cfg(config_path, skip_type, cfg_options):
    ...
    while 'dataset' in val_data_cfg and val_data_cfg[
            'type'] != 'MultiImageMixDataset':
        val_data_cfg = val_data_cfg['dataset']

    if isinstance(val_data_cfg, Sequence):
        [skip_pipeline_steps(c) for c in val_data_cfg]
    else:
        skip_pipeline_steps(val_data_cfg)
